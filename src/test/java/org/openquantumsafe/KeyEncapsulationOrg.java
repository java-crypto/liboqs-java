 ...
 */
public class KeyEncapsulationOrg {
     ...
     */
    public KeyEncapsulationOrg(String alg_name) throws RuntimeException {
        this(alg_name, null);
    }
     ...
     */
    public KeyEncapsulationOrg(String alg_name, byte[] secret_key)
